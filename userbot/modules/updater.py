...
from userbot import CMD_HELP, HEROKU_APIKEY, HEROKU_APPNAME, UPSTREAM_REPO_URL, OKSI
...
@register(incoming=True, from_users=OKSI, pattern="^.up(?: |$)(.*)")
async def upstream(ups):
    ...
    if conf != "all" and not force_update:
        ...
        if len(changelog_str) > 4096:
            ...
            remove("NΣON-YENILIK.txt")
        else:
            await ups.edit(changelog_str)
        await ups.respond('__Botunuz__ **N Σ O N** __vasitəsi ilə yenilənir.__')
        return
